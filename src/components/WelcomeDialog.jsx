...
const slides = [
  {
    ...
    description: 'Tu plataforma para ver anime, leer manga y novelas ligeras. Todo gratis y en español.',
  },
  {
    icon: (
    ...
    description: 'Navega por el directorio, mira tendencias, calendario de emisión y temporadas. Encuentra tu próxima serie favorita.',
  },
  {
    icon: (
    ...
    title: 'Subtítulos y seguimiento',
    description: 'Reproduce episodios con subtítulos personalizables. Lleva el progreso al día y crea tu lista personal.',
  },
  {
    icon: (
    ...
    title: 'Comunidad',
    description: 'Escribe reseñas, comenta episodios, aporta enlaces y sigue a otros usuarios. Forma parte de la comunidad.',
  },
]

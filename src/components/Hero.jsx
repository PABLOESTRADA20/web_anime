  ...
  return (
    <section className="relative h-[420px] sm:h-[520px] rounded-3xl overflow-hidden mb-12 group">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 30% 50%, oklch(0.65 0.25 330 / 0.4) 0%, transparent 60%), radial-gradient(ellipse at 70% 20%, oklch(0.75 0.18 210 / 0.2) 0%, transparent 50%)',
        }}
      />
      ...
      <motion.div
        ...
        <motion.h1
          ...
          <span className="bg-gradient-to-r from-white via-white to-white/70 bg-clip-text text-transparent">{title}</span>
        </motion.h1>
        ...
        <motion.div
          ...
          <Link
            ...
            <span
              className="absolute inset-[-1px] rounded-xl opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"

...
let PUBLIC_PROXIES = ['https://api.allorigins.win/raw?url=', 'https://corsproxy.io/?url=']
try {
  const raw = import.meta.env.VITE_PROXY_FALLBACKS
  if (raw) PUBLIC_PROXIES = JSON.parse(raw)
} catch {

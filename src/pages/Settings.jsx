  ...
  if (!user) {
    return (
      <>
        ...
        <div className="max-w-xl mx-auto py-12 text-center text-text-secondary">
  ...
  return (
    <>
      ...
      <div className="max-w-xl mx-auto">
        <GradientHeading variant="pink" size="lg" className="mb-8">Configuración del perfil</GradientHeading>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-surface border border-white/10 text-sm placeholder:text-text-secondary/40 focus:outline-none focus:border-primary/50 transition-all"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              maxLength={500}
              rows={4}
              className="w-full px-4 py-2.5 rounded-xl bg-surface border border-white/10 text-sm placeholder:text-text-secondary/40 focus:outline-none focus:border-primary/50 transition-all resize-none"
            />
          </div>
        ...
        <div className="mt-12">
          <GradientHeading variant="pink" size="md" className="mb-4">Notificaciones push</GradientHeading>
          <div className="bg-surface rounded-2xl p-6 space-y-2">
            {push.supported ? (
              ...
              <p className="text-sm text-text-secondary text-center py-2">Las notificaciones push no están disponibles en este navegador.</p>
            )}
        ...
        <div className="mt-10 mb-12">
          <GradientHeading variant="pink" size="md" className="mb-4">Preferencias de notificación</GradientHeading>

    ...
    <>
      <SeoHead title={
        mode === 'reset-request' || mode === 'reset-confirm'
          ? 'Restablecer contraseña' : 'Iniciar sesión'
      } />
        ...
        <div className="mt-6">
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-background px-3 text-text-secondary/50">o continúa con</span>
            </div>
          </div>
          ...
          <>
            <p className="text-text-secondary">
              ...
              <button onClick={() => { setMode('register'); setError(''); setMessage('') }}
                className="text-primary hover:underline">Regístrate</button>
            </p>
            <p>
              <button onClick={() => { setMode('reset-request'); setError(''); setMessage('') }}
        ...
        {mode === 'register' && (
          <p className="text-text-secondary">
            ...
            <button onClick={() => { setMode('login'); setError(''); setMessage('') }}
              className="text-primary hover:underline">Inicia sesión</button>
          </p>
        )}
        {(mode === 'reset-request' || mode === 'reset-confirm') && (
          <p className="text-text-secondary">
